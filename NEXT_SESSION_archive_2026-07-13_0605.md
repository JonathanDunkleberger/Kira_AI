...
## 🛑 SHIFT-53 (2026-07-12 ~19:33, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→52 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:33, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 HALL OF FAME / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 35 [e4] / 14 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:32, live-banking) = party=[venusaur **L92** (90→92 since shift-52 — ace resumed climbing, still hogging grind XP) / kadabra 40 / dugtrio 41 / primeape 39 / dugtrio 39 / lapras 43] — bench FLAT ~L40, ace L92 = a ~52-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion; the ace-hogs-XP lopsidedness keeps worsening in real time — L92 ace / L40 bench). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-52 (2026-07-12 ~19:31, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→51 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (mtime=now 19:30, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 33 [e4] / 13 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:29, live-banking) = party=[venusaur **L90** (88→90 since shift-51 — ace resumed climbing, still hogging grind XP) / kadabra 40 / dugtrio 41 / primeape 39 / dugtrio 39 / lapras 43] — bench FLAT ~L40, ace L90 = a ~50-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion; the ace-hogs-XP lopsidedness keeps worsening in real time — L90 ace / L40 bench). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-51 (2026-07-12 ~19:28, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→50 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (mtime=now 19:27, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 29 [e4] / 11 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:24, live-banking) = Indigo Plateau, party=[venusaur **L88** (UNCHANGED since shift-49 — ace plateaued) / kadabra 40 / dugtrio 40 / primeape 39 / dugtrio 39 / lapras 42] — bench FLAT ~L40, ace L88 = the same ~46-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion; ace-hogs-XP lopsidedness capped now — both ace and bench plateaued). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-50 (2026-07-12 ~19:26, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→49 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (mtime=now 19:26, 2 python PIDs): whole-log **0 banked_CREDITS / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 27 [e4] / 10 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:24, live-banking) = Indigo Plateau, all 8 badges, ace still climbing/hogging grind XP (≈L88) / bench FLAT ~L40 = the same ~46-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-49 (2026-07-12 ~19:24, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→48 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:24, 2 python PIDs): whole-log **0 banked_CREDITS / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 25 [e4] / 9 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:20, live-banking) = Indigo Plateau, all 8 badges, party levels=[venusaur **L88** (85→88 since shift-48 — ace still climbing/hogging grind XP), 40, 40, 39, 39, 42] — bench FLAT L39-42, ace L88 = the same ~46-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion; ace-hogs-XP lopsidedness worsening in real time). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-48 (2026-07-12 ~19:21, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→47 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:21, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 HALL OF FAME / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 22 [e4] / 8 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:20, live-banking) = Indigo Plateau, party [venusaur **L85** (82→85 since shift-47 — ace resumed climbing, still hogging the grind XP), kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L42] — bench FLAT L39-42, ace L85 = the same ~45-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion; the ace-hogs-XP lopsidedness keeps worsening in real time — L85 ace / L40 bench). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-47 (2026-07-12 ~19:19, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→46 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:19, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 HALL OF FAME / 0 Traceback / 0 outcome=STALL** (reached_indigo present). Last 300k chars = 7 VR-GRIND / 20 [e4] / 7 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:15, live-banking) = badges=8 Indigo, party [venusaur **L82** (UNCHANGED since shift-46 — ace plateaued), kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L41] — bench FLAT L39-41, ace L82 = the same ~42-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-46 (2026-07-12 ~19:16, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→45 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:16, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 HALL OF FAME / 0 Traceback / 0 outcome=STALL** (reached_indigo ×2). Last 300k chars = 7 VR-GRIND / 18 [e4] / 6 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:15, live-banking) = badges=8 Indigo, party [venusaur **L82** (80→82 since shift-45 — ace resumed climbing, still hogging the grind XP), kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L41] — bench FLAT L39-41, ace L82 = the same ~40-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-45 (2026-07-12 ~19:14, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→44 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:14, 2 python PIDs 39828/37168): whole-log **0 banked_CREDITS / 0 HALL OF FAME / 0 Traceback / 0 outcome=STALL**; last 300k chars = 8 VR-GRIND / 16 [e4] / 5 whiteout (grinding + retrying, NOT tight-spinning). banked_LIVE (mtime 19:12, live-banking) = badges=8 Indigo, party [venusaur **L80** (UNCHANGED since shift-44 — ace plateaued too now), kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L41+Ice Beam] — bench FLAT L39-41, ace L80 = the same 40-level gap, NS#22 bounded non-convergence continuing (VR2F caps ~L46 < the L60 that already fails the champion). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run = SINGLE-RUN LAW; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-44 (2026-07-12 ~19:11, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→43 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:11, 2 python PIDs): last 300k chars = 8 VR-GRIND / 12 [e4] / 3 whiteout (grinding + retrying, NOT tight-spinning), **0 Traceback (whole log), 0 outcome=STALL (whole log), 0 banked_CREDITS**. banked_LIVE (mtime 19:09, live-banking) = badges=8 Indigo, party [venusaur **L80** (77→80 since shift-43), kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L41+Ice Beam] — the ace keeps HOGGING the grind XP (71→74→77→80 over shifts 40→44) while the **bench is FLAT-plateaued ~L40** (VR2F caps ~L46 < the L60 that already fails the champion, NS#22 = the same bounded non-converging loop; the ace-hogs-XP root is visibly worsening the lopsidedness in real time — L80 ace / L40 bench = a 40-level gap). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run; HARD RULE forbids a night blind-edit of the grind cadence). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-43 (2026-07-12 ~19:09, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→42 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, VR2F-grinding + retrying the E4. `fresh_go_1.log` (34MB, mtime=now 19:09, 2 python PIDs): last 200k chars = 6 VR-GRIND / 10 [e4] / 2 whiteout (grinding + retrying, NOT tight-spinning), 0 Traceback (whole log), 0 outcome=STALL, no banked_CREDITS, reached_indigo present. banked_LIVE (mtime 19:09, live-banking) = badges=8 Indigo, party [venusaur **L77** (74→77 since shift-41), kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras **L41**+Ice Beam] — the ace keeps climbing but the bench is plateaued ~L40 (VR2F caps ~L46 < the L60 that already fails the champion, NS#22 = same bounded non-converging loop). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-42 (2026-07-12 ~19:06, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38→41 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, productively VR2F-cave-grinding + retrying the E4. Verified `fresh_go_1.log` (34MB, mtime=now 19:06, 2 python PIDs): last 20k lines = 16 VR-GRIND vs 8 e4/whiteout (mostly grinding, NOT tight-spinning), 0 Traceback (whole log), 0 outcome=STALL (recent), no banked_CREDITS. banked_LIVE (mtime 19:04, live-banking) = badges=8 Indigo, party [venusaur L74, kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L40] — UNCHANGED vs shift-41 (VR2F has plateaued the bench ~L40, caps ~L46 < the L60 that already fails the champion, NS#22 = same bounded non-converging loop). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-41 (2026-07-12 ~19:04, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-38/39/40 state LIVE and STILL healthy — and the VR2F grind is measurably WORKING (bench climbed since shift-40): `fresh_go_1.log` mtime=now, 2 PIDs, last ~15 markers = VR-GRIND (not tight-spinning), 0 Traceback/0 STALL, no fresh banked_CREDITS. banked_LIVE (mtime 18:52, live-banking) = badges=8 Indigo, party [venusaur L74, kadabra L40, dugtrio L40, primeape L39, dugtrio L39, lapras L40] — kadabra 35→40, dugtrio 36→40, primeape 37→39, venusaur 71→74 vs shift-40, so the grind evens the bench toward the ace but still caps ~L46 < the L60 that already fails the champion (NS#22 = same bounded non-converging loop). NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-40 (2026-07-12 ~19:01, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Re-confirmed the shift-39 state LIVE and STILL healthy: fresh run at the E4 TEAM-DEPTH wall, productively VR2F-cave-grinding. Verified `fresh_go_1.log` mtime=now, 2 PIDs, 0 Traceback/0 STALL, last markers = VR-GRIND (not tight-spinning); banked_LIVE mtime 18:52 (live-banking) = badges=8 Indigo, party [venusaur L71, kadabra L35, dugtrio L36, primeape L37, dugtrio L38, lapras L40 w/ Ice Beam]. NO commit — the only wall is the Monday-only team-depth build (verify-gated, emulator held by this run). Frontier UNCHANGED (below). Left cooking; exited fast. The shift-39 block below is the full record — its resume plan is still exact. START HERE ↓

## 🛑 SHIFT-39 (2026-07-12 ~18:55, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. The shift-38 prediction is CONFIRMED LIVE: the fresh run reached the E4 with a THIN organic bench and is whiteout-looping / VR2F-grinding = the NS#22 TEAM-DEPTH wall. This is the deep Monday verify-gated root (HARD RULE: no night blind-edit). Run is HEALTHY, left cooking. START HERE ↓
**STATE (verified from `fresh_go_1.log` 223.9k lines, mtime=now, 2 python PIDs, banked_LIVE mtime 18:52):** the fresh bedroom→credits run walked the WHOLE game autonomously — **all 8 badges → Victory Road → Indigo Plateau → the E4** (the entire nav rope proven end-to-end, the mission's biggest milestone). banked_LIVE = **badges=8, Indigo Plateau, levels=[venusaur L71, kadabra 35, dugtrio 36, primeape 37, dugtrio 38, lapras 40]** (party of 6, Lapras L40 = the champion answer but far under level). She tried the E4, **whited out 11×**, and is now in **Victory Road 2F (map 1,40) running the ARMED VR2F cave-grind** (`POKEMON_CAVE_GRIND`, band L36-46), winning battles, leveling the bench. **This is NOT a wedge/crash/freeze-spin — she is productively grinding**, the best autonomous behavior at this wall. Only 5 e4/whiteout events in the last 20k lines = she's mostly grinding, not tight-spinning.
**WHY IT WON'T CONVERGE (the confirmed NS#22 wall, don't re-derive):** the bench arrives THIN (L35-40) because the ACE HOGS XP all game (Venusaur L71 solos everything → the bench gets only participation crumbs). The VR2F cave-grind is the only endgame grind spot, but its wilds (L36-46) ≈ the bench → per NS#7 grind-spot-INADEQUACY the participation XP is near-zero, and per NS#22 VR2F **caps ~L43-46, BELOW the L60 bench that ALREADY fails the champion** (e4_tactical_v2: Lapras L60 solo'd 5 of Gary's 6 then fell). So this run grinds the bench to VR2F's ~L46 cap, retries the E4, whiteout-loops at the champion forever — a bounded, NON-converging endgame loop. **The organic bench is simply too thin to roll credits.**
**THE REAL FIX = whole-climb organic leveling (the fresh-GO leveled-6, `TEAM_DEPTH_ROOT_FIX.md`) — a MONDAY verify-gated build, NOT a night edit.** The bench must arrive at Indigo already leveled (~L50+), which means leveling it DURING the climb (gyms 1-8), not at the endgame. The root lever = `POKEMON_BENCH_TO_MILESTONE` default ON (WAR order 2/3 — the ns12_benchtoms_reverify multi-gym park-safety gate) + killing the ace-hogs-XP participation share (selective-solo/kill-XP levers). **ALL verify-gated (a fresh multi-gym look-ahead confirming no park/treadmill) — HARD RULE forbids blind-shipping a grind-cadence change at the context/budget wall, and the SINGLE-RUN LAW blocks a second look-ahead while THIS fresh run holds the emulator.** So it is unambiguously the Monday-refill job.
**WHY NO COMMIT THIS SHIFT (honest):** the ONLY wall is the forbidden-at-night team-depth build; the run is healthy; killing it to start the team-depth build would (a) lose the live nav-rope proof + any NEW VR/E4-leg walls it might surface, (b) rush a deep verify-gated build at the budget wall = exactly the HARD-RULE anti-pattern. There is no night-safe committable fix here. Left the run cooking, characterized precisely, exited fast per WAR order 4/5.
**AT RESUME (Monday, emulator free) — glance `fresh_go_1.log` FIRST:** `grep -aoE "banked_CREDITS|HALL OF FAME|CHAMPION.*(beat|won)|reached_indigo|Traceback" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh (unlikely — thin bench) → verify + write CREDITS line-1 of NIGHT_REPORT.md + survey. (2) Still badges=8 whiteout-looping / VR2F-grinding (expected) → **BUILD the team-depth fix** (the mission): flip `POKEMON_BENCH_TO_MILESTONE` default ON gated on a fresh badge-3→6 multi-gym look-ahead (`recon_longrun.py surge_done_kit.state 90`) proving the bench climbs toward each milestone with NO park/treadmill + arrives Fuchsia ~L36-40; decision-check `recon_bench_milestone_check.py` first (12/12). Then a FRESH bedroom→credits run with the flag ON must arrive at Indigo with a leveled-6 → the E4 falls → the 5× reliability battery. (3) A NEW wall on a VR/E4 leg → capture + root-fix. ⚠️ Do NOT kill the detached fresh run to free the emulator until you're ready to START the team-depth verify — it's the live nav-rope proof. Watchdog relaunch if dead: `unset $(env | grep -oE '^POKEMON_[A-Z_]+'); nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-38 detail below is the prior record; its badge-6→8→VR→Indigo climb is CONFIRMED (banked_LIVE badges=8 at Indigo) — the E4 team-depth wall it predicted is now CONFIRMED LIVE above.

## ⚔️ SHIFT-38 (2026-07-12 ~18:45, WAR order 1) — ROOT-KILLED the Route-20 reboot-treadmill at its TRUE site (the Seafoam strike aborted on UNTAUGHT HM04 Strength), committed `e6eea42`, and VERIFIED e2e LIVE: badge 6 → **7 (Blaine)** → **8 (Giovanni)** → climbing VICTORY ROAD, all persisted to banked_LIVE. START HERE ↓
**WHAT SHIFT-37 GOT WRONG (proven from `fresh_go_1.log`, not guessed):** shift-37's "she's actively doing the Seafoam crossing" was a MISREAD — the `STOPPED_SEAFOAM` markers were just the flag NAME printed in the questline STEP description text, NOT the flag being set. She entered the Seafoam interior **0 times** in the whole 149k-line log. Every recon_longrun iteration ended `OUTCOME: STALL — no progress for 14 decisions at (3,38)@(119,3)` (Route 20 crossing point); the watchdog carries only `banked_GOAL` forward (never STALL), so banked_LIVE stayed FROZEN at Route 18 and every reboot re-stalled = a confirmed reboot-treadmill (56+ dead iters, 0 forward progress). Disabling the over-level lever (shift-37) did NOT fix it because the over-level was never the blocker.
**THE TRUE ROOT (traced):** the Seafoam crossing strike aborts `party lacks Surf/Strength (surf=True str=False)` on EVERY attempt → exhausts its 3 tries at Fuchsia (3,7) → never enters the interior → head_to_gym `no_path` at Route 20 (surface severed) → STALL. The Safari grants HM03 Surf AND HM04 Strength **together** (`SAFARI DONE: strength=True`), but only Surf is DRIVEN to a teach (Blaine's gym prereq via the teach bridge); the seafoam gate's KB prereq chain is `surf` only, so **HM04 Strength sat in the bag UNTAUGHT**. The interior boulder cascade shoves boulders with Strength, so the strike could never start. (REJECTED the KB-prereq fix `seafoam→strength→gold_teeth`: gold_teeth has `success=None` → `_step_satisfied` always reads it unsatisfied → would surface a re-acquire wedge.)
**THE FIX (committed `e6eea42`, localized + fail-closed):** new `campaign._ensure_owned_hm_taught(hm)` teaches an already-owned HM (in the TM case) via the proven teach primitive (`default_plan` → a free-slot bench mon → no move lost); the Seafoam strike PREFLIGHT calls it for Strength before aborting. A failed teach leaves the party intact and the abort still fires (never worse than the old loop). Both files parse.
**LIVE-VERIFIED e2e (this shift):** iter 57 (fixed code) → `🧭 ENSURE-HM: strength -> primeape (slot 3, forgetting move 116/Focus Energy, power 0) → taught` → `ON ROUTE 20` → interior strength/push/fall boulder cascade → `FLAG_STOPPED_SEAFOAM_B3F_CURRENT = 1` → `WEST SEA` → `reached_cinnabar` → Secret Key (Mansion) → **Blaine → badge 7 (Volcano)** → Cinnabar→Viridian sea road → **Giovanni → badge 8 (Earth)** → **VICTORY ROAD** climbing. banked_LIVE PERSISTED at **badges=8 levels=[70,35,36,37,38,40]** (180s live-bank fired; the reboot-treadmill is DEAD, progress compounds forward).
**⇒ FRONTIER = the E4 TEAM-DEPTH WALL (NS#22, the known deep root — SEPARATE from tonight's fix).** She is now climbing VR toward Indigo → E4 with a THIN bench: Venusaur L70 ace + bench L35-40 (Kadabra/Dugtrio×2/Primeape/Lapras). The E4 is L54-63 + Champion Gary; NS#22 proved a thin bench walls at Lance/Champion (needs Lapras ~L65-72 OR two L55+ coverage attackers, whole-climb organic leveling per `TEAM_DEPTH_ROOT_FIX.md`). She will likely whiteout-loop at the E4 — that is the NEXT frontier, NOT tonight's fix. **AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "banked_CREDITS|HALL OF FAME|\\[e4\\] room|CHAMPION|whiteout|live-bank\\] STAGE -> banked_LIVE +badges=[0-9]|reached_indigo|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md + survey. (2) badges=8 looping at the E4 (Lorelei/Bruno/Agatha/Lance/whiteout) → the NS#22 team-depth wall; the fresh-GO leveled-6 is the mission (verify-gated Monday build, NOT a night blind-edit — HARD RULE). (3) A NEW wall on the VR→Indigo→enter_league legs → capture + root-fix that leg (shift-15 wired the whole dispatch; a recurrence is a nav gap). Watchdog relaunch if dead: `unset $(env | grep -oE '^POKEMON_[A-Z_]+'); nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`. ⚠️ NOTE: banked_LIVE carries badges=8 now; each iteration re-teaches Strength (idempotent) + re-crosses as needed. The over-level lever stays OFF (shift-37, correct — bench already over-leveled).
**⚠️ MONDAY (belt-and-suspenders, verify-gated):** the teach could be driven EARLIER (proactively, at Fuchsia, not just in the strike preflight) so a fresh bedroom→credits run teaches Strength before the crossing without relying on the strike's preflight — but the preflight teach is sufficient and proven. The deeper root is the whole-climb team-depth (bench arrives thin) — the E4 wall.
↓ SHIFT-37 detail below is the prior record; its "she's LIVE-CROSSING to Cinnabar" claim was the MISREAD this shift disproved (0 interior entries) — the true root was the untaught-Strength strike abort, now fixed.

## ⚔️ SHIFT-37 (2026-07-12 ~18:22, WAR order 1+4) — The shift-36 shadow-bug fix WORKED (the floor-26 treadmill is DEAD: bench climbed 8→32→35). But she STILL wasn't crossing — diagnosed the TRUE remaining root = a **REBOOT-TREADMILL** (a DIFFERENT root than the shadow bug), and operationally UNBLOCKED it by disabling the over-level lever (already over-leveled → cross now). She is LIVE-CROSSING to Cinnabar. START HERE ↓
**WHAT WAS ACTUALLY STILL WRONG (traced from `fresh_go_1.log`, not guessed — the shift-36 fix is fine, this is downstream):** the shadow-bug fix let the bench climb 8→32→L35 (banked_LIVE roster: venusaur L66, kadabra L35, dugtrio L36, primeape L37, dugtrio L38, lapras L37+Surf — a COMFORTABLE Blaine team). But she treadmilled at Route 18 without crossing. ROOT (code-read + log-proven): the over-level milestone target is **Blaine L48**, UNREACHABLE at Route-18 (wilds L23-29), so `_overlevel_before_sealeg` keeps returning 48 (defers the crossing) until floor≥42. It only RELEASES via the per-badge retire flag `_overlevel_sealeg_dry_badge` (set on a productive bite at campaign.py:11963, or on `no_safe_grass` at :11887). **The retire flag is an IN-MEMORY instance attr — it does NOT survive the recon_longrun ITERATION REBOOT** (the watchdog runs recon_longrun in ~10-min iterations, each re-booting from `banked_LIVE`). LIVE PROOF (iter 6, log lines 166755→167455): the over-level RETIRED (`reverting to the crossing`) → PROACTIVE SEAFOAM opened → she crossed **Route 18→Fuchsia→Route 19→Route 20 (ONE hop from Cinnabar)** → then the iteration hit its `rc=0` deadline MID-CROSSING → the crossing progress was AFTER the last 180s live-bank so it wasn't persisted → iter 7 re-booted from `banked_LIVE` (still Route 18) with the over-level flag re-armed → re-deferred. **A reboot-treadmill: she reaches Route 20 every iteration and gets reset.** Compounded by the NS#7 heal-excursion churn (450 excursions) eating each iteration's productive time BEFORE the retire fires, leaving too little time to finish the multi-map Seafoam crossing.
**THE FIX (operational, no code edit, reversible, LIVE-VERIFIED — `fresh_go_watchdog.sh` now `export POKEMON_OVERLEVEL_SEALEG=0`):** the over-level lever ALREADY did its job — banked_LIVE arrives over-leveled (floor 35, ace L66). Disabling it makes `_overlevel_before_sealeg` return None from tick 1 → PROACTIVE SEAFOAM opens IMMEDIATELY (no ~590s of over-level grinding first) → she heads straight to cross with the FULL iteration budget, using the already-banked leveled bench. This is the documented **flag-OFF baseline (shift-5 LIVE-verified NEVER-WORSE)** — the thin-team reason it was armed in shift 6 no longer applies (this bench is L35-66, a comfortable Blaine win, not the NS#4 L25-29 coin-flip). GRASSLESS_CROSSING_GYMS={"Blaine"} only, so OFF is byte-safe for the rest of the climb. Also relaunched with a GUARANTEED-CLEAN env (unset all POKEMON_ vars except the one flag) per the shift-36 leaked-flag lesson.
**LIVE-VERIFIED (after relaunch, ~2 min):** boot banked_LIVE Route 18 badges=6 → **NO "OVER-LEVEL"/"crossing deferred" markers** → `PROACTIVE SEAFOAM` tick 1 → Route 18→Fuchsia→Route 19→**Route 20 + Seafoam interior** (`STOPPED_SEAFOAM` becalm-the-current flag firing 97×, 894 Seafoam refs) → **actively doing the Seafoam Strength-boulder crossing to Cinnabar**, 0 Traceback/STALL. The reboot-treadmill is DEAD; she's on the proven shift-11/28 Seafoam crossing.
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "STATE IN: Cinnabar|Volcano.*EARNED|badges=[7-8]|banked_CREDITS|Traceback|outcome=STALL|banked one bite" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md + survey. (2) `STATE IN: Cinnabar` + badges=7 (Volcano) → she crossed + beat Blaine (ace L66 crushes it) → climbing Giovanni(8)→VR→E4 → clean, exit fast. (3) still Route 18/20 badges=6 with `STOPPED_SEAFOAM` → mid-crossing, healthy, let it cook (the Seafoam interior + heal-churn is slow but progresses; NO "crossing deferred" = the fix holds). (4) if she's back to `OVER-LEVEL BEFORE SEA LEG ... crossing deferred` → the watchdog got relaunched WITHOUT the flag (check `fresh_go_watchdog.sh` still has `export POKEMON_OVERLEVEL_SEALEG=0`; relaunch: `unset $(env | grep -oE '^POKEMON_[A-Z_]+'); nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`). ⚠️ KNOWN post-cross walls are SEPARATE deeper roots: Blaine on grass-less Cinnabar is now a comfortable win (ace L66 vs L40-47, NOT the NS#4 thin-team coin-flip); the E4 is the NS#22 team-depth wall (whole-climb organic leveling, `TEAM_DEPTH_ROOT_FIX.md`).
**⚠️ MONDAY — the PROPER code-fix (verify-gated, the reboot-treadmill is the real root, NOT the shadow bug):** the over-level retirement must survive the iteration reboot. Options: (a) PERSIST `_overlevel_sealeg_dry_badge` (or a "crossing-committed" flag) in the banked state so the reboot doesn't re-arm the over-level (a resume-sanctity fix per rule 17); OR (b) LOWER the over-level milestone target to a REACHABLE modest bite (shift-6's "one +6 bite then cross" intent — not Blaine's full L48 which Route-18 wilds L23-29 can't reach) so it RELEASES within one iteration before a reboot. ALSO a real latent companion bug: the `no_safe_grass` over-level release (campaign.py:11886) is STILL gated on the stale `_ovl_sealeg_pending` flag — the EXACT bug NS#35 root-killed in the productive branch (11962) by keying off the LIVE `_overlevel_before_sealeg(state)`; fix the no_safe_grass branch the same way. All verify-gated (a fresh look-ahead + the recon checks), NOT a night blind-edit. But NOTE: the env-flag OFF is sufficient for THIS banked_LIVE run to reach credits (over-level's value is already banked); the proper fix only matters for re-arming it on a FRESH bedroom→credits run.
↓ SHIFT-36 detail below is the prior record; its shadow-bug fix (`0ac69be`) is CORRECT + confirmed WORKING (bench climbed 8→32) — the reboot-treadmill above is the downstream root it revealed.

## ⚔️ SHIFT-36 (2026-07-12 ~17:56, WAR order 1) — ROOT-KILLED the shifts-30-35 Route-18 soft-treadmill at its TRUE site: the PRODUCTIVE-BITE branch's SHADOW BUG (committed `0ac69be`). The shift-34/35 over-level fixes were correct but DEFEATED by (a) a leaked `POKEMON_BENCH_TO_MILESTONE=1` env into the fresh run + (b) the productive-bite branch marking `_lopsided_grind_done` ONLY inside the over-level `if`. Relaunched the run with a CLEAN env from `banked_LIVE`. START HERE ↓
**WHY the shift-35 fix was STILL inert (proven from `fresh_go_1.log`, not guessed):** the run treadmilled Route 18 at badges=6, floor L26→L32, `LOPSIDED-DBG ... ms=48 ... done=[]` FOREVER, `banked one bite` 0×, `STATE IN: Cinnabar` 0×, 387 HEAL-EXCURSIONs. In iter 3 there was exactly **1 productive bite** (30->32 @ line 149582) and **4 ace_healed** stints. On that ONE productive bite the NS#35 release `if self._overlevel_before_sealeg(state) is not None:` (campaign.py:11945) read FALSE → the release skipped AND — the crux — `_lopsided_grind_done` was NEVER marked (it was only added INSIDE that `if`), while `_lopsided_pending_ms = None` at ~11953 SHADOWED the shift-25 universal park-proof at ~11971 (which marks done on any terminal stint but only when pending is still set). So L48 stayed unmarked → LOPSIDED-BENCH severity re-fired every tick → pruned head_to_gym → she re-ground Route-18's L23-29 grass toward the UNREACHABLE L48 milestone forever. WHY over-level read None on a productive bite despite `_bench_to_ms_active` being True at 11896 (a contradiction under default flags): the run booted with a **leaked `POKEMON_BENCH_TO_MILESTONE=1`** (from a prior verify shell the shift-28 watchdog relaunch inherited) → `_bench_to_ms_active` was True via the GLOBAL flag, not the over-level scope, so the productive-bite branch fired while `_overlevel_before_sealeg` was None → the over-level release never got the chance the NS#35 fix assumed.
**THE FIX (committed `0ac69be`, campaign.py:11933, deterministic + never-worse):** mark `_lopsided_grind_done.add(_lop_ms)` **UNCONDITIONALLY** at the top of the productive-bite `else` branch (before the over-level release `if`), exactly like the shift-25 park-proof does for every non-productive terminal stint. A productive bite IS a completed lopsided stint; LOPSIDED is one-stint-per-badge by its own design (the multi-bite keep-climb is the prep-pin's job, not LOPSIDED's). So after ONE productive bite → L48 marked done → LOPSIDED stops re-firing → head_to_gym resumes → she marches south → the no_safe_grass / over-level release crosses her to Cinnabar (the NS#6-proven one-bite-then-cross). Byte-inert in the working over-level case (the release already added `_lop_ms`); can only REDUCE grinding, never increase it.
**ALSO: relaunched with a GUARANTEED-CLEAN env** (this shell has NO `POKEMON_` vars → default flags → `BENCH_TO_MILESTONE` OFF) so the fresh run runs the intended organic-six default behavior, not the leaked multi-bite mode. With `BENCH_TO_MILESTONE` OFF the NS#35 fast path ALSO works (over-level non-None on the productive bite → `banked one bite` → immediate cross); the shadow-bug fix is the belt-and-suspenders that also covers any tick where over-level reads None mid-iter.
**DECISION-VERIFIED OFFLINE (emulator busy = SINGLE-RUN LAW):** `recon_ns34_onebite_cross_check.py` **8/8** (added case E: a productive bite with over-level None STILL marks LOPSIDED done → no treadmill) + `recon_overlevel_sealeg_check.py` **13/13** (no regression). campaign.py parses OK.
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "banked one bite|STATE IN: Cinnabar|Volcano.*EARNED|badges=[7-8]|banked_CREDITS|Traceback|outcome=STALL|LOPSIDED-DBG.*done=\[[0-9]" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md + survey. (2) `STATE IN: Cinnabar` + badges=7 (Volcano) → the treadmill is DEAD e2e, she's climbing Blaine→Giovanni→VR→E4 → clean, exit fast. (3) `LOPSIDED-DBG ... done=[48]` (or done containing the milestone) after the next productive bite = the fix engaged even if she hasn't crossed yet → healthy, let it cook. (4) STILL `done=[]` + floor stuck after a full productive stint → the ace_healed HEAL-EXCURSION churn is starving productive bites entirely (387 excursions is the deeper drag): the Monday build is killing the heal-excursion frequency (`GRIND_ACE_BAIL_FRAC` lower / a lower over-level bite target so a bite completes before the ace dips), per NS#7 — verify-gated, NOT a night edit. ⚠️ KNOWN post-cross walls are SEPARATE deeper roots: Blaine on grass-less Cinnabar is an NS#4 coin-flip (over-level tips the retry), the E4 is the NS#22 team-depth wall. Watchdog relaunch if dead: `unset $(env | grep -oE '^POKEMON_[A-Z_]+' ); nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown` (the `unset` guarantees no leaked verify flag).
↓ SHIFT-35 detail below is the prior record; its LIVE-condition release fix (`37cec08`) is CORRECT but was defeated live by the leaked flag + the shadow bug this shift root-killed.

## ⚔️ SHIFT-35 (2026-07-12 ~17:52, WAR order 1+3) — ROOT-KILLED the shift-34 fix's OWN inert-flag bug (committed `37cec08`); the shifts 30-34 Route-18 soft-treadmill was STILL LIVE. Relaunched the fixed run from `banked_LIVE`. It crosses to Cinnabar after the next productive over-level bite. START HERE ↓
**WHY SHIFT-34's FIX WAS INERT (proven from the live log, not guessed):** `fresh_go_1.log` (156k lines, PID 39212 on the fixed shift-34 code since 17:40:40) logged `BENCH-TO-MS: productive bite` **2×** (floor 26→32) but `banked one bite` **0×**, `LOPSIDED-DBG ... done=[]` forever, HEAL-EXCURSION churn, badges=6, never crossed = the identical treadmill. shift-34 gated the release on the **CACHED `_ovl_sealeg_pending`**, which is set-and-`return`ed inside `_ensure_forward_questline` (campaign.py:9838) on a DIFFERENT tick/path, so at the grind executor (campaign.py:11934) it reads **FALSE** → the release `if` never ran → a productive bite cleared `_lopsided_pending_ms` WITHOUT marking `_lopsided_grind_done` (the `elif r=="ready"` done-mark at ~11943 is SHADOWED by the `_bench_to_ms_active` productive-bite branch at 11896) → LOPSIDED re-fired every tick toward the UNREACHABLE Blaine L48 milestone (Route-18 wilds L23-29). shift-34's own `_ovl_sealeg_pending IS set True every tick` claim was WRONG. Its decision test passed 6/6 only because it **HARDCODED `_ovl_sealeg_pending=True`** — validated the arithmetic, never the guard's live reachability.
**THE FIX (committed `37cec08`, campaign.py:11934):** key the release off the **LIVE `self._overlevel_before_sealeg(state) is not None`** instead of the stale cached flag. Reaching this branch already requires `_bench_to_ms_active(state)` True (line 11896), which with `BENCH_TO_MILESTONE` default OFF **means** `_overlevel_before_sealeg` is non-None — the SAME source of truth that gates the crossing defer (7267) and the `_ensure_forward_questline` defer (9837). So: over-level active + one productive bite → set `_overlevel_sealeg_dry_badge = badge` + mark `_lopsided_grind_done` → `_overlevel_before_sealeg` returns None next tick → BOTH gates release (LOPSIDED stops + Seafoam crossing opens) → she CROSSES with the modest over-level banked (shift-6-proven one-+6-bite→Indigo). Multi-bite mode (over-level inactive → None) byte-unchanged.
**DECISION-VERIFIED OFFLINE (emulator busy = SINGLE-RUN LAW):** `recon_overlevel_sealeg_check.py` **13/13** (no regression — `_overlevel_before_sealeg` untouched) + `recon_ns34_onebite_cross_check.py` REWRITTEN to key off the LIVE condition, **7/7** incl. the new **B regression case** (over-level active + `_ovl_sealeg_pending`=FALSE → release STILL fires — exactly the case the shift-34 guard would have skipped). campaign.py parses OK.
**RESUMED:** killed the treadmilling run (PID 39212, old code in memory); the watchdog **auto-relaunched** at 17:51:55 (PID 24860, 2 PIDs = one run) from `banked_LIVE` (Route 18, badges=6) on the FIXED code (campaign.py mtime 17:49:11 predates proc start). Log shows it booted + grinding Route 18. The next productive over-level stint (~600s) fires the release → she crosses.
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "banked one bite|STATE IN: Cinnabar|Volcano.*EARNED|badges=[7-8]|banked_CREDITS|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md + survey. (2) `🏝️ OVER-LEVEL: banked one bite` + `STATE IN: Cinnabar` + badges=7 (Volcano) → the fix WORKED e2e, she's climbing to Giovanni → clean, exit fast. (3) STILL grinding Route 18 at badges=6 with NO `banked one bite` after a full productive stint → the release condition still isn't reached: check the stint is returning `r in ("ready","ok")` (if it's `ace_healed`/`no_safe_grass`-dominated the productive-bite branch at 11896 is never entered — that would be a DIFFERENT root: the HEAL-EXCURSION churn means the ace keeps dipping and the stint rarely completes a productive bite; the deeper fix is then killing the heal-excursion frequency / a lower over-level bite target, per NS#7 — a Monday verify-gated build, not a night edit). ⚠️ The KNOWN post-cross walls are SEPARATE deeper roots: Blaine on grass-less Cinnabar is an NS#4 coin-flip (over-level tips the retry to a win), the E4 is the NS#22 team-depth wall (whole-climb organic leveling per `TEAM_DEPTH_ROOT_FIX.md`). Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-34 detail below is the prior record; its `_ovl_sealeg_pending`-scoped fix was committed (`7894276`) but proven INERT live this shift (the flag reads False at the executor) — superseded by the LIVE-condition fix `37cec08` above.

## ⚔️ SHIFT-34 (2026-07-12 ~17:40, WAR order 1+3) — ROOT-KILLED the shifts 30-33 Route-18 over-level SOFT-TREADMILL (committed `7894276`, decision-verified) + RELAUNCHED the fixed run. It crosses to Cinnabar after the next productive over-level bite. START HERE ↓
**WHAT WAS ACTUALLY WRONG (corrects shift-33's own read):** the floor was NOT flat — a fresh glance showed it climbing 26→29→30→32 (+2/stint, `BENCH-TO-MS: productive bite 30->32`), but toward an **UNREACHABLE** Blaine L48 milestone on Route-18's L23-29 grass = the multi-bite marathon **NS#7 explicitly retired** as grind-inadequate. shift-33's "zero floor gain" trigger would never have fired (gains aren't zero).
**THE PRECISE ROOT (code-read, 2 independent gates):** LOPSIDED re-firing is gated on `_lopsided_grind_done` (campaign.py:7320) BUT the **CROSSING defer is INDEPENDENT** — `_ensure_forward_questline` (campaign.py:9837) defers the Seafoam crossing as long as `_overlevel_before_sealeg(state) != None`, which only releases via `_bench_poor_maps` / floor≥milestone-CLOSE / `_overlevel_sealeg_dry_badge`. The grind executor's **productive-bite branch** (campaign.py ~L11915) cleared `_lopsided_pending_ms` WITHOUT marking done AND without releasing the crossing → LOPSIDED re-fired + crossing stayed deferred → she re-ground Route 18 toward L48 forever. The uncommitted shift-29 diff marked only `_lopsided_grind_done` → **inert** (crossing still deferred; shift-33 was right it was loaded-but-non-working, just for the deeper reason: it never touched the crossing gate). `_ovl_sealeg_pending` IS set True every tick during the over-level (campaign.py:9838) — shift-33's "barely ever set" was wrong; my live grep + decision check confirm it's the active driver.
**THE FIX (committed `7894276`, campaign.py ~L11929, replaces the shift-29 diff):** in the productive-bite branch, when `_ovl_sealeg_pending` (the over-level is the driver — NOT the global `BENCH_TO_MILESTONE` flag), after ONE productive bite retire the over-level for THIS badge via `_overlevel_sealeg_dry_badge = badge` (+ clear `_ovl_sealeg_pending` + mark `_lopsided_grind_done`). That is the **SAME per-badge release the `no_safe_grass` NEVER-WORSE path uses (campaign.py:11887), which shift-5 LIVE-verified crosses** → `_overlevel_before_sealeg` returns None next tick → BOTH gates release (LOPSIDED stops + Seafoam crossing opens) → she CROSSES to Cinnabar with the modest over-level banked (the **shift-6-proven one-+6-bite-then-cross that reached Indigo**). Scoped to `_ovl_sealeg_pending` so `BENCH_TO_MILESTONE` multi-bite mode (flag default OFF) is byte-unchanged; a POOR first bite already crosses via `_bench_poor_maps`.
**DECISION-VERIFIED OFFLINE (emulator busy = SINGLE-RUN LAW, no look-ahead possible):** `recon_overlevel_sealeg_check.py` **13/13** (no regression — `_overlevel_before_sealeg` untouched; case 10b already proves `dry_badge→None→cross`) + new `recon_ns34_onebite_cross_check.py` **6/6** (A over-level ACTIVE before the bite / B scoped to `_ovl_sealeg_pending` / C RELEASES after one bite / C2 pending cleared / C3 LOPSIDED marked done / D re-arms per-badge — not a permanent kill).
**RESUMED (WAR order 4 root-fix→resume):** killed the stale run (booted 17:33 on OLD code, treadmilling); the watchdog **auto-relaunched** at 17:40:40 (2 PIDs = one run, no double-launch) from `banked_LIVE` on the FIXED code — iter 5, badges=6, `STATE IN: Fuchsia`, Route 18, 0 traceback. The next productive over-level stint (~600s) fires the release → she crosses.
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "OVER-LEVEL: banked one bite|STATE IN: Cinnabar|Volcano.*EARNED|badges=[7-8]|banked_CREDITS|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md. (2) `🏝️ OVER-LEVEL: banked one bite ... crossing to Cinnabar` + `STATE IN: Cinnabar` + badges=7 (Volcano) → the fix WORKED e2e, she's climbing to Giovanni → clean, exit fast. (3) STILL grinding Route 18 at badges=6 with NO "banked one bite" line after a full stint → the productive-bite branch isn't reaching the release (check `_ovl_sealeg_pending`/`_bench_to_ms_active` are True live; the branch needs `r in ("ready","ok")` — if the stint returns `ace_healed`/`no_safe_grass` it takes a DIFFERENT already-crossing path). ⚠️ The KNOWN post-cross walls are SEPARATE deeper roots, not tonight's fix: Blaine on grass-less Cinnabar is an NS#4 coin-flip (over-level tips the retry to a win), and the E4 is the NS#22 team-depth wall (whole-climb organic leveling per `TEAM_DEPTH_ROOT_FIX.md` — the Monday-refill mission). Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-33 detail below is the prior record; its "flat floor / zero net XP / grind-inadequacy Monday-fix" read is superseded — the floor was climbing, the fix is a one-bite-then-cross release (committed + live), not a grind-inadequacy trigger.

## 🛑 SHIFT-33 (2026-07-12 ~17:24, WAR order 4) — GLANCE. **CORRECTS shifts 30-32's "she'll cross" optimism: the Route-18 over-level is a CONFIRMED SOFT-TREADMILL, not slow-but-real progress.** No blind-fix (verify-gated Monday root). START HERE ↓
**THE DISPROOF (verified `fresh_go_1.log`, 144.75k lines, mtime=now, 2 PIDs, badges=6, Route 18 (3,36)):** `floor crossed L26` at **line 134561** with party `[26,26,58,26,27,26]`. NOW at line 144748 the party read is **IDENTICAL** `[Venu58, Dugt26, Lapr26/Surf, Mank26, Kada27, Dugt26]` → **ZERO net floor XP across ~10,200 lines** (the floor never once rose above 26; even Kadabra is still L27). And **`reverting to the crossing` / `STATE IN: Cinnabar` appear ZERO times in the WHOLE 144.75k-line run** → the over-level lever has held her at Route 18 **for the entire run and never released to cross.** Health still clean (0 STALL / 0 Traceback / 0 ANTI-WEDGE / 87 battles last 3000 lines) — so it's a SOFT treadmill (cleanly battling, banking ~0 floor XP), NOT a crash. This fulfils shift-32's own escalation trigger verbatim ("floor STILL exactly 26 after a MUCH longer window with no `reverting to the crossing` and no poor-spot-release → soft-treadmill on inadequate grass, NS#7 root, the Monday-refill fix").
**THE ROOT — PINPOINTED THIS SHIFT (and it is NOT the lever shifts 27-32 named):** the treadmill is driven by the **LOPSIDED-BENCH severity gate**, NOT the over-level-sealeg lever (only **4 `OVER-LEVEL/sealeg` markers in the WHOLE 144.75k-line run**; the recent window logs `LOPSIDED-BENCH: bench severely behind milestone L48 (solo-carry…)`). Mechanism: party = ace Venu L58 + bench L26 → lead−floor=32 (≥15) AND milestone−floor=22 (≥12) → LOPSIDED severity fires → forces a grind stint + PRUNES head_to_gym. Route 18 (L23-29 wilds) can't move an L26 bench toward the **L48** milestone → floor flat → the stint is non-productive → **`milestone L48 — done` is logged ZERO times in the whole run** → the L48 milestone is NEVER retired → LOPSIDED re-fires every tick → she grinds Route 18 forever, never marches south to the grass-less Route 19/20 whose `no_safe_grass` would retire the over-level and CROSS (the NS#6 flow). **The shift-25 `7f2132d` "mark done on ANY terminal stint" does NOT cover this** (the BENCH-TO-MS keep-climb re-pin path returns before the terminal-done logic, OR the non-productive stint status isn't classified terminal). **The uncommitted shift-29 fix (below) is MIS-SCOPED** to `_ovl_sealeg_pending` (barely ever set → LOPSIDED drives this, not the over-level push) AND sits in the "productive bite" branch (doesn't apply when the floor is FLAT) → that is exactly WHY it's loaded-but-inert.
**🩹 UNCOMMITTED SHIFT-29 FIX IN THE TREE — LOADED + PROVEN NON-WORKING (shifts 30-32 never noticed it):** `git diff pokemon_agent/campaign.py` = a 14-line "WAR NS#29 OVER-LEVEL PARK-PROOF" edit (~L11918) that marks `_lopsided_grind_done.add(_lop_ms)` when `_ovl_sealeg_pending` in the productive-bite branch. **campaign.py mtime 17:06:15, both python PIDs started 17:06:58 → the running process HAS this fix loaded, and it STILL treadmills** (iter-3 booted banked_LIVE at log line 135170, ran 9,600+ lines, floor never left 26). So this approach is a DEAD END — do not commit it; either revert or rewrite at the correct site (below). It IS a useful record of what was tried.
**WHAT I DID:** glanced → found the uncommitted shift-29 fix → proved via mtimes it's loaded-and-failing → root-caused to the LOPSIDED-BENCH severity re-fire (L48 milestone never marked done). **NO code change** — the correct fix is a LOPSIDED grind-cadence edit = HARD-RULE-forbidden to blind-ship at night (@CLAUDE.md ~L405 no-shortcuts) + unverifiable (SINGLE-RUN LAW, emulator busy) + ~$61 budget. Left the detached run + the uncommitted shift-29 diff alone; committed this sharpened diagnosis as proof-of-life.
**⚠️ MONDAY — THE FIX (verify-gated; correct SITE identified): a resume of `banked_LIVE` will NOT self-cross — it IS this treadmill.** Fix the **LOPSIDED-BENCH keep-climb** (campaign.py ~L11890-11930, the `_lop_ms`/`_lopsided_grind_done` path), NOT the `_ovl_sealeg_pending` branch: when a LOPSIDED grind spot is **grind-INADEQUATE** (K consecutive stints, ZERO floor gain — the floor is flat, wilds are far below the bench), mark `_lopsided_grind_done.add(_lop_ms)` → head_to_gym resumes → she marches to Route 19/20 → `no_safe_grass` retires the over-level → CROSSES to Cinnabar (underleveled, but crossing ≫ treadmilling). Then **revert the mis-scoped shift-29 diff** and boot a **corrected fresh run** (delete banked_LIVE per shift-27). Deeper/better = fresh-GO whole-climb organic leveling so she arrives Fuchsia ~L36-40 (NS#6/#7, `TEAM_DEPTH_ROOT_FIX.md`) — but the LOPSIDED-inadequacy release is the minimal unblock. NB even after crossing, Blaine on grass-less Cinnabar is an NS#4 coin-flip and the E4 is a separate team-depth wall (NS#22) — this only unblocks the Fuchsia→Cinnabar leg.
**AT RESUME — glance first:** `grep -aoE "reverting to the crossing|STATE IN: Cinnabar|badges=[7-8]|banked_CREDITS|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. If any of those NOW appear (unlikely without a code fix) → she broke out; verify + exit. If still floor=26 at Route 18 → it's the confirmed treadmill above; build the Monday fix, don't glance-and-leave a 4th time. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-32 detail below is the prior record; its "slow-but-real forward progress / she plateaus then crosses" read is the OPTIMISM this shift disproves (floor never moved, never crossed).

## 🩺 SHIFT-32 (2026-07-12 ~17:22, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Box-swap Surf fix HOLDING; run alive+advancing on the KNOWN NS#7 Route-18 over-level slog. Floor crossed **L26**, mid-bite toward **L32**. START HERE ↓
**STATE (verified from `fresh_go_1.log`, 142.8k lines, mtime=now, 2 PIDs):** badges=6, crossed the sea-gate, over-leveling at Route 18 (3,36). `GRIND-WEAK: floor crossed L26 (levels [26,26,58,26,27,26]) — done` (line 134561) → `BENCH-TO-MS: productive bite 21->26` → now `LOPSIDED-DBG floor=26 lead=58 ms=48 prep_t=32` = grinding the next +6 bite toward L32 en route to the Blaine **L48** milestone. Latest party `[venusaur L58, dugtrio L26, lapras L26 (Surf), mankey L26, kadabra L27, dugtrio L26]`. **Health: 0 STALL / 0 Traceback / 0 ANTI-WEDGE / 0 `reverting to the crossing` in the WHOLE 142.8k-line log; 0 banked_CREDITS.** Last 3000 lines = 175 battles + productive-bite marker + only 3 R18↔Fuchsia heal trips (the heavy heal-churn window is EARLIER, ≤line ~134k; recent window is clean grinding). NOT a wedge — slow-but-real forward progress. ⚠️ NOTE: floor was 26 at shift 31 too and is STILL mid-bite-to-32 (~8k lines later) — the L26+ bench on Route-18's L23-29 wilds gets near-0 XP/battle (NS#7 grind-spot-INADEQUACY), so the L26→32 bite is SLOW; she plateaus ~L29-30 then poor-spot-releases + crosses to Cinnabar underleveled per NS#6. Expected, not a stall.
**WHAT I DID:** glanced the log (WAR order 4). CLEAN → left cooking, no code change. Did NOT blind-fix the verify-gated over-level/team-depth root (HARD RULE @CLAUDE.md ~L405; ~$61 budget; emulator busy = SINGLE-RUN LAW so no fix could be verified anyway). Frontier UNCHANGED — it is genuinely the Monday-refill whole-climb organic-leveling build (below).
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "HM-BOX-SWAP|badges=[7-8]|Volcano.*EARNED|Earth|STATE IN: Cinnabar|banked_CREDITS|Traceback|outcome=STALL|reverting to the crossing" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md. (2) badges=7 (Volcano) + climbing to Giovanni → over-level cleared Blaine e2e, clean, exit fast. (3) STILL grinding Route 18 at badges=6 → over-level slog per NS#7; verify she eventually crosses (look for `reverting to the crossing` → then `STATE IN: Cinnabar`). ⚠️ If the floor is STILL exactly 26 after a MUCH longer window with no `reverting to the crossing` and no poor-spot-release → the L26→32 bite may be a soft-treadmill on inadequate grass (NS#7 root); that's the Monday-refill fix (earlier whole-climb leveling / lower the sea-leg over-level bite target so she crosses sooner), NOT a night blind-edit. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-31 detail below is the prior record; its read is IDENTICAL to this shift (same slow Route-18 grind, floor at L26 mid-bite).

## 🩺 SHIFT-31 (2026-07-12 ~17:16, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Same as shift-30: box-swap Surf fix HOLDING, run alive+advancing on the KNOWN NS#7 Route-18 over-level slog. START HERE ↓
**STATE (verified from `fresh_go_1.log`, 140.8k lines, mtime=now, 2 PIDs):** badges=6, crossed the sea-gate, over-leveling at Route 18 (3,36). Bench floor climbing **14→20→26** via `BENCH-TO-MS: productive bite` toward the Blaine **L48** milestone; latest full party read `[26, 26, 58, 26, 27, 26]` (Venusaur L58 ace + bench L26-27). **0 outcome=STALL, 0 Traceback, 0 ANTI-WEDGE (last 3000 lines), 0 badges=7.** The ~6k log-lines since the L26 floor-cross (line 134561) = the KNOWN NS#7 Route-18 grind-spot-INADEQUACY (wilds L23-29 ≈ the L26 bench → near-0 XP/battle + Fuchsia heal-churn: last 2000 lines = 1 GRIND-WEAK + 2 HEAL-EXCURSION + 1 R18↔Fuchsia round-trip). NOT a wedge — real-but-slow forward progress; she creeps to ~L29-30 then poor-spot-releases + crosses to Cinnabar per NS#6.
**WHAT I DID:** glanced the log (WAR order 4). CLEAN → left cooking, no code change. Did NOT blind-fix the verify-gated over-level/team-depth root at ~$61 budget (explicitly forbidden; emulator busy = SINGLE-RUN LAW). Frontier UNCHANGED (below).
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "HM-BOX-SWAP|badges=[7-8]|Volcano.*EARNED|Earth|STATE IN: Cinnabar|banked_CREDITS|Traceback|outcome=STALL|reverting to the crossing" /g/temp/longrun/fresh_go_1.log | tail`. (1) `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md. (2) badges=7 (Volcano) + climbing to Giovanni → over-level cleared Blaine e2e, clean, exit fast. (3) STILL grinding Route 18 at badges=6 (no `reverting to the crossing`) → over-level treadmilling on inadequate grass (NS#7 root) but self-releases on poor-spot → likely still fine, verify she eventually crosses. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-30 detail below is the prior record; its read is IDENTICAL to this shift (she is on the same slow Route-18 grind, floor at L26).

## 🩺 SHIFT-30 (2026-07-12 ~17:12, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. The shift-28 box-swap Surf-wedge fix is CONFIRMED HOLDING e2e; the fresh run crossed the sea-gate and is on the KNOWN NS#6/#7 over-level Route-18 grind toward Blaine. START HERE ↓
**STATE (verified from `fresh_go_1.log` mtime=now + `banked_LIVE` partydump):** box-swap wedge DEAD — `HM-BOX-SWAP`+`TEACH BRIDGE: surf` fired, `banked_LIVE` party = **Venusaur L58 / Dugtrio L26 / Lapras L26 (Surf) / Mankey L26 / Kadabra L27 / Dugtrio L26**, badges=6, next_gym=Blaine (Volcano). She crossed the Fuchsia sea-gate and is grinding at **Route 18 (3,36)** under the NS#6 OVER-LEVEL-BEFORE-SEA-LEG lever: `LOPSIDED-BENCH: bench severely behind milestone` → bench floor climbing steadily **14→20→26** toward the Blaine L48 milestone. Run ALIVE + advancing (2 python PIDs, battles winning, floor rising). The **23× Route-18↔Fuchsia (3,36)↔(3,7) heal round-trips** = the KNOWN grind-spot-inadequacy/heal-churn (NS#7): Route-18 wilds L23-29 ≈ the L26 bench → slow XP + heavy heal churn. NOT a wedge — real forward progress.
**WHAT I DID:** glanced the log (WAR order 4). CLEAN → left cooking, no code change. Box-swap fix holding, she's climbing. Did NOT blind-fix the verify-gated over-level/team-depth root at ~$61 budget (explicitly forbidden).
**⚠️ THE FRONTIER (the deep root, verify-gated, DON'T blind-fix at budget — it is the whole remaining mission):** the over-level Route-18 grind is SLOW + heal-churny (NS#7 decisive: Route 18 is grind-spot-INADEQUATE for an L26+ bench; the bench will plateau ~L29-30 then poor-spot-release + cross to Cinnabar underleveled → Blaine coin-flip that the over-level tips to a retry-win per NS#6). The real fix is EARLIER whole-climb organic leveling (the fresh-GO leveled-6, `TEAM_DEPTH_ROOT_FIX.md`) + killing the heal-excursion frequency — a careful Monday-refill build, NOT a night blind-edit.
**AT RESUME — glance `fresh_go_1.log`:** `grep -aoE "HM-BOX-SWAP|badges=[7-8]|Volcano.*EARNED|Earth|STATE IN: Cinnabar|banked_CREDITS|Traceback|outcome=STALL|reverting to the crossing" /g/temp/longrun/fresh_go_1.log | tail`. (1) If `banked_CREDITS` fresh → verify + write CREDITS line-1 of NIGHT_REPORT.md. (2) If badges=7 (Volcano earned) + climbing to Giovanni → the over-level cleared Blaine e2e, clean, exit fast. (3) If STILL grinding Route 18 at badges=6 with `MAP TRANSITION (3,36)<->(3,7)` churn (no `reverting to the crossing`) after a long window → the over-level is treadmilling on inadequate grass (NS#7 root); characterize, but it self-releases on poor-spot, so likely still fine — verify she eventually crosses. (4) The KNOWN post-Blaine wall = E4 TEAM-DEPTH (NS#22, separate deep root). Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-28 detail below is the prior record (box-swap fix); its e2e-verified root-kill is CONFIRMED STILL HOLDING this shift.

## ⚔️ SHIFT-28 (2026-07-12 ~16:53, WAR order 1+3) — ROOT-KILLED the shift-27 Blaine Surf sea-gate credits-wedge (committed `1a5b6ea`, isolated-VERIFIED) + relaunched the fresh run through the fix. START HERE ↓
**SHIFT-27's DIAGNOSIS WAS HALF-WRONG — corrected from the log:** shift 27 said "silph_strike NEVER collects the Lapras." The log DISPROVES that — line 116707 `LAPRAS banked -> talked (flag=True)`: silph_strike DOES collect it. THE REAL ROOT: the organic run over-caught **3 redundant Digletts** → party FULL (6) → when the Silph strike collected the free Lapras it **auto-boxed** (FRLG boxes a gift taken at party-6). Confirmed via `recon_boxscan.py` on banked_LIVE: PARTY=[venusaur,3×diglett,mankey,kadabra] (0 surf), BOX0.slot4=**lapras (surf=True)**. So she HAS the Surf-mon — in the box — and never fielded it → `hm_teach.default_plan(surf)=None` → the teach bridge (campaign.py:8475) logs `!! TEACH: no compatible party mon for surf` EVERY cycle (shift 27 wrongly said this line "never logs") → `questline_unresolved` → PROACTIVE HM-PREREQ re-fires Safari → infinite loop.
**THE FIX (committed `1a5b6ea`, campaign.py, ORGANIC — a real player benches a spare Diglett for their Lapras to get Surf):** at the teach bridge, when `default_plan(hm)=None`, call the NEW `_box_swap_for_hm(hm,state)` → deposits a redundant DUPLICATE (the 3rd Diglett, via new `_hm_swap_chaff` which boxes the lowest-level dup even if the line is on-plan) + withdraws the boxed HM-learner (Lapras) via the existing NS#38/39 `deposit_mon`/`withdraw_mon` machinery → re-derives `default_plan` on the fielded team. Purely additive to a dead-end failure path; fail-closed + LOUD (a failed/absent swap ≠ worse than the status-quo loop). NOT gated (it's a hard credits-blocker on an already-failing path; PC actuation is RAM-verified + aborts clean).
**VERIFIED TWICE — isolated AND e2e-LIVE (the wedge is DEAD):** (1) isolated `recon_hm_boxswap_check.py` ALL PASS (boxed a diglett 6→5, withdrew lapras 5→6, `default_plan(surf)`→real plan). (2) **e2e in the relaunched live run (fresh_go_1.log:129103-129117): at Fuchsia City badge6, `PCBOX 6→5` (boxed a diglett) → `5→6` (withdrew lapras 131) → `🔀 HM-BOX-SWAP: fielded lapras` → `🧭 TEACH BRIDGE: surf -> lapras` → `[teach] VERIFIED: slot5 moves [54,..]→[57,..]` (57=SURF in the moveset) → `TEACH BRIDGE result: taught` → `[meet] INTRODUCTION: lapras joined the party` (soul narrated meeting it) → `questline cleared`. ctx now reads "You have SURF — you can cross water", party=[venusaur L56,...,lapras L25], next_gym=Blaine.** She fired the fix within ~2 min of relaunch (all known ground) and is now marching to Cinnabar. THE BLAINE CREDITS-WEDGE IS ROOT-KILLED, CONFIRMED LIVE.
**STATE:** killed the doomed reboot-loop + watchdog, relaunched the watchdog detached (PID 136193) booting banked_LIVE with the FIXED code. It crossed the wedge (above) and is climbing Blaine(7)→Giovanni(8)→VR→E4. Canonical saves UNTOUCHED.
**AT RESUME — glance `fresh_go_1.log`:** `grep -oE "HM-BOX-SWAP|TEACH BRIDGE: surf|badges=[7-8]|Volcano|Earth|STATE IN: Cinnabar|banked_CREDITS|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. (1) If `🔀 HM-BOX-SWAP: fielded lapras` + `badges=7` (Volcano) → the wedge is DEAD e2e; she's climbing toward the E4 → clean, exit fast (or check for the KNOWN E4 team-depth wall below). (2) If she's STILL looping at Blaine (Safari re-do, no HM-BOX-SWAP line) → the swap isn't firing in the live flow: check she's at a mapped-Center city when the prereq fires (Fuchsia=(3,7) IS in CITY_PC_DOORS), or the box isn't the open box (`withdraw_mon` needs the learner in cur_box — box-switch is unbuilt). (3) `⛔ NEXT KNOWN WALL after Blaine = E4 TEAM-DEPTH` (NS#22): bench arrives thin (venusaur L55 + L20s bench + a low-level Lapras), Champion needs Lapras ~L65-72 OR two L55+ attackers — a SEPARATE deep root, not tonight's wedge. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
**⚠️ SECONDARY (the deeper root, verify-gated, DON'T blind-fix at budget):** the box-swap is the durable *fallback*, but the over-catch itself (`pokemon_planner._recompute_status` scans PARTY only, never the PC box → re-catches 3 Digletts instead of covering the type/HM gap) is the true cause of the thin bench + capped dex. Fixing it (box-aware slot satisfaction / owned-count guard) would let a fresh run land Lapras in the PARTY directly + build a fuller 6 — the E4-team-depth lever. Careful, organic, needs a fresh multi-gym look-ahead.
↓ SHIFT-27 detail below is the prior record; its "silph_strike never collects Lapras" root-cause is SUPERSEDED (it collects, then auto-boxes — fixed above).

## 🧬 SHIFT-27 (2026-07-12 ~16:36, WAR order 4) — REAL WEDGE CAPTURED (NOT blind-fixed — it's the deep verify-gated team-composition root; needs Monday budget). The fresh run cleared Sabrina (badges 5→6) then HARD-WEDGED at the Blaine Surf sea-gate: her full party has **ZERO Surf-capable species**, so she got HM03 Surf but can NEVER teach it → infinite Safari re-do → cannot reach Cinnabar. START HERE ↓
**THE WEDGE (root-caused precisely from `fresh_go_1.log` ~119k lines + code read — NOT guessed):** party = `[venusaur L56, diglett L22, diglett L21, mankey L21, kadabra L27, diglett L20]`, badges=6 (Marsh earned), next_gym=Blaine. To reach Cinnabar she needs HM03 Surf. `PROACTIVE HM-PREREQ: Blaine needs surf` opens the Safari errand → `SAFARI DONE: surf=True` (she GETS HM03) → but **`hm_teach.default_plan(surf)` returns None** because NONE of Venusaur/Diglett/Mankey/Kadabra can learn Surf (verified against the authoritative ROM gTMHMLearnsets read in `hm_compatible`). So the `('cap','surf')` step (= "a party mon KNOWS surf") is **permanently unsatisfiable** → `PROACTIVE HM-PREREQ` re-fires → she RE-RUNS the Safari → **infinite re-do loop** (3 cycles observed, each ~1300 lines: PROACTIVE@117127→SAFARI DONE@117839→PROACTIVE@118439→SAFARI DONE@119004→PROACTIVE@119621…). She is badge 6 and **physically cannot progress to badge 7**. Run ALIVE (log mtime=now, 2 PIDs), 0 Traceback — but soft-wedged, will NOT self-progress.
**WHY THIS IS THE DEEP ROOT (the surfaced form of the long-flagged over-catch):** the team-brain over-caught **3 redundant digletts** and NEVER acquired a Water/Surf mon (root = `pokemon_planner._recompute_status` scans PARTY only, never the PC box → re-catches duplicates instead of covering the type/HM gap). Surf is a HARD physical gate, so "thin bench" escalated from a battle nuisance into a **credits-blocking wall**. This is exactly the verify-gated, ORGANIC team-building mission (HARD RULE @CLAUDE.md ~line 405: no fast-and-dirty, no blind end-of-context edits, do it COMPLETELY + verify).
**WHY I DID NOT FIX IT TONIGHT (honest — WAR budget + HARD RULE):** a correct fix is a DEEP organic change I cannot safely blind-ship or verify at the budget/context wall (SINGLE-RUN LAW: the one emulator is busy; ~$61 budget). Blind-patching team-composition/strike code is the symptom-patch pattern that has burned Jonny. So I captured + handed off (WAR order 5). **NO code change, NO commit this shift.**
**THE FIX (Monday-refill, build + verify, then boot a CORRECTED fresh run — priority order):**
  1. **CLEANEST ORGANIC FIX = collect the free LAPRAS gift in Silph Co.** In FRLG a 7F employee gives a free Lapras (Water/Ice) after you rescue the president/clear Silph — it's THE Surf-user AND the Blaine/Lance/Champion answer. Every Sherpa fixture (koga_done_kit/surf_ready_kit) HAS Lapras; a fresh run doesn't → `silph_strike.py` almost certainly never collects it. Wire the Lapras gift into the silph strike (talk the 7F NPC, accept, it lands in party/box). VERIFY: a fresh run reaches Silph → collects Lapras → later teaches Surf → crosses to Cinnabar. This is the highest-leverage single fix (also fixes the E4 team-depth — Lapras is the champion answer).
  2. **BACKSTOP / general fix = when HM03 is obtained but no party mon can learn it, the plan must ACQUIRE a Surf-capable Water mon** (Safari Zone has Psyduck/Poliwag/Slowpoke near water; PC/BOX to free a diglett slot — `POKEMON_PCBOX` default OFF, NS#38/39). Deeper; do #1 first.
  3. **Also: the infinite Safari re-do is itself wasteful** — the NS#11 `_hm_in_case` guard (skip the fire-first strike once HM03 is in the case, campaign.py ~8168) is apparently reading `_hm_in_case=False` (the teach bridge's `plan is None → "questline_unresolved"` LOUD line at campaign.py ~8479 is NEVER logged, and the Safari strike re-fires). Confirm whether HM03 is truly in the TM case (`hm_teach.tm_case_row(b,341)`) — if it IS and `_hm_in_case` still reads False, that's a narrower read bug. But this only stops the wasted compute; it does NOT advance credits (a `questline_unresolved` still leaves her Surf-less at the sea-gate). #1 is the real fix.
**AT RESUME (Monday):** THIS wedge is a NEW deep root, NOT the shift-25 LOPSIDED-shuttle (that stays closed). Build fix #1, verify, then **delete `banked_LIVE` + boot a corrected fresh run** (the watchdog boots banked_LIVE = this Surf-less badge-6 state, so it just re-wedges — a fresh run with the Lapras fix is required). Canonical saves UNTOUCHED. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`. ⚠️ The detached run is soft-looping harmlessly (no crash) — kill it Monday before booting the corrected run (`taskkill //F //IM python.exe //T`).
↓ SHIFT-26 detail below is the prior record; its "watch cooking, chain proven by prior passes" read MISSED that a fresh run's ORGANIC team lacks the Surf mon the Sherpa fixtures were hand-given — the sea-gate is a fresh-GO-specific wall.

## 🩺 SHIFT-26 (2026-07-12 ~16:27, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. The fresh run (shift-25 LOPSIDED fix HOLDING) advanced PAST Saffron: it LIBERATED Silph Co (beat Giovanni → `saffron_free=True`, unblocks Sabrina) and is now INSIDE Sabrina's gym (badge 6) fighting junior trainers via the pad router. START HERE ↓
**STATE (verified from `fresh_go_1.log`, ~117k lines, log LIVE mtime=now):** since shift 25 (badges=5 at Saffron) she cleared the Silph Co. liberation questline — rode the warp-pad maze up the floors, healed the hostages, beat **GARY (grudge #7)** and **GIOVANNI** on 11F → `silph strike: SAFFRON FREED (flag 0x3E)` → walked out, healed/shopped → oracle `PICK head_to_gym` → `⛰️ AT Sabrina's city — ENTERING the gym` → **inside Sabrina's gym (14,3), pad router ARMED, engaging junior trainers (winning)**. Party `[venusaur L55, 3× diglett L20-22, mankey L21, kadabra L27]`, badges=5, dex 11, next_gym=Sabrina. Run **ALIVE + advancing** (2 python PIDs 39256/40952, live-bank badges=5): **15 MAP TRANSITIONs vs 18 recoverable "identical fp x4" markers in the last 4000 lines** — the markers are the Silph 11F pad-maze approach to Giovanni + the Sabrina pad-gym (each self-recovers at x4, "returning to roam LOUD, no inner spin"), NOT a spin. The 2 giovanni "couldn't reach (6,12)" fails were TRANSIENT — she recomputed and reached Giovanni (saffron_free fired). **0 outcome=stuck, 0 ANTI-WEDGE, 0 Traceback.**
**WHAT I DID:** glanced the log (WAR order 4). CLEAN → left cooking, no code change. The shift-25 LOPSIDED-shuttle root-kill is holding (she marches + clears gyms, no shuttle).
**AT RESUME:** glance `fresh_go_1.log` — `grep -oE "badges=[6-8]|Marsh.*EARNED|Volcano|Earth|MAP TRANSITION.*(Fuchsia|Cinnabar)|banked_CREDITS|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. If she cleared Sabrina (badges≥6) and is climbing toward Blaine (Safari/Surf→Cinnabar chain, proven NS#6/#10-13) → clean, exit fast. If STALLing at a NEW spot (Sabrina gym pad-maze / Fuchsia grass-reach / Cinnabar sea-leg) → capture + root-fix that leg. NB the LOPSIDED-shuttle root is closed GENERALLY, so a recurrence would be a DIFFERENT root. ⚠️ SECONDARY (known, verify-gated, DON'T blind-fix at budget): the redundant-3-digletts over-catch (party has 3 digletts) caps a thin bench — `pokemon_planner._recompute_status` scans PARTY only, never the PC box; not a blocker (Venusaur L55 ace carries). Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-25 detail below is the prior record; its Koga→Saffron leg is now superseded (she's PAST Silph, inside Sabrina's gym).

## ⚔️ SHIFT-25 (2026-07-12 ~16:30, WAR order 1) — ROOT-KILLED the Fuchsia/Route-15 grind-shuttle STALL (shift-24's "recoverable churn" had escalated to a hard STALL). Fresh run now BEAT KOGA (badges 4→5) + is at SAFFRON for Sabrina. Committed `7f2132d`. START HERE ↓
**WHAT I FIXED (committed `7f2132d`, campaign.py, VERIFIED e2e):** iter 1 hit a hard **STALL at Route 15 (3,33)@(0,11)** — the Fuchsia-approach gatehouse. ROOT (traced, not guessed): she's AT Fuchsia (Koga's city) with an L51 ace that crushes Koga's L37-43, but **LOPSIDED-BENCH forced a grind stint at the gym city and PRUNED head_to_gym** every tick. Fuchsia's Route-13/14/15 grass is sealed behind the gatehouse → grind returns `ok`/`no_safe_grass` with 0 bite → the milestone was marked `_lopsided_grind_done` ONLY on a productive `ready` stint → a grind-IMPOSSIBLE region left it UNMARKED (`LOPSIDED-DBG done=[]` every tick) → LOPSIDED re-fired forever → **Fuchsia↔Route-15 shuttle → 14-decision STALL, never fought Koga.** FIX (byte-inert on the productive paths): mark `_lopsided_grind_done` on ANY terminal lopsided stint (except mid-heal `ace_healed`) so the lever fires ≤once/badge as its own design states → head_to_gym survives → she marches in + beats the gym; bench-leveling resumes organically. **VERIFIED e2e from the stalled `banked_STALL` (Route 15 (0,11)):** done marks → LOPSIDED retires → ENTERS Koga's gym → **badges 4→5 (Soul)** → next_gym=Sabrina → marched to **Saffron City**.
**STATE:** watchdog RELAUNCHED detached (fixed code), booted banked_LIVE at **badges=5**, already at **Saffron City** for Sabrina (gym 6). The Fuchsia→Koga→Sabrina→Silph chain is PROVEN by prior passes (night-train s3/s8/s9, NS#4/#10) — she's now on it.
**AT RESUME:** glance `fresh_go_1.log` — `grep -oE "badges=[6-8]|Marsh|Volcano|Earth|banked_CREDITS|Traceback|outcome=STALL" /g/temp/longrun/fresh_go_1.log | tail`. If she cleared Sabrina (badges≥6) and is climbing → clean, exit fast. If STALLing at a NEW spot (Saffron gatehouse / Silph / Sabrina gym) → capture + root-fix that leg. NB the LOPSIDED-shuttle root is now closed GENERALLY (any grind-impossible gym-city), so a recurrence at another gym would be a DIFFERENT root. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-24 detail below is the prior record; its "recoverable churn" read was optimistic — the same spot hard-STALLED this shift and is now root-fixed.

## 🩺 SHIFT-24 (2026-07-12 ~16:06, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. The fresh run marched FURTHER SOUTH than shift 23 and is now working the Route 12→13→14→15 gatehouse-maze approach to Fuchsia for KOGA (badge 5). START HERE ↓
**STATE (verified from `fresh_go_1.log`, sim 2651s, log LIVE — advanced +438 lines / +130 sim-s during the glance):** since shift 23 (leaving Lavender south) she has pushed the head_to_gym march DEEPER south — recent transitions show **Route 12 (3,30) → Route 13 (3,31) → Route 14 (3,32) → Route 15 (3,33)** = the closest to Fuchsia she's reached, fighting wild encounters as she goes. Still badges=4 (Boulder/Cascade/Thunder/Rainbow), next_gym=Koga, party venusaur+3×diglett+mankey+kadabra. Run **ALIVE + advancing** (2 python PIDs 44464/40244, mtime=now): **15 MAP TRANSITIONs vs 18 recoverable "identical fp x4" markers in the last 4000 lines** — the markers are scattered across the Route 13/14/15 gatehouse maze + indoor maps (8,0 gate / 1,89 / 1,92), each self-recovers at x4 ("returning to roam LOUD, no inner spin"), NOT a spin. One small 4-marker cluster at the (8,0) gate building self-cleared and she moved on. **0 outcome=stuck, 0 ANTI-WEDGE, 0 Traceback.** The Route-13/14/15 gatehouse oscillation is the KNOWN Fuchsia-approach churn (Route-15-gatehouse); the Fuchsia→Koga→Sabrina chain is PROVEN by prior passes (night-train s8/s9, NS#4/#10). Sim-to-real ~0.6× = CPU contention + battle density, not a livelock.
**WHAT I DID:** glanced the log (WAR order 4). CLEAN → left cooking, no code change.
**AT RESUME:** glance `fresh_go_1.log` — `grep -oE "badges=[5-8]|Soul.*EARNED|Marsh|Volcano|Earth|MAP TRANSITION.*Fuchsia|banked_CREDITS|Traceback" /g/temp/longrun/fresh_go_1.log | tail`. If she reached Fuchsia → cleared Koga (badges≥5) and is climbing toward Sabrina → clean, exit fast. If STALLing at a NEW spot (Route 13/14/15 gatehouse maze / Fuchsia approach / Koga gym) → capture + root-fix that leg. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-23 detail below is the prior record; superseded by the above (she's now deeper south, at the Route 13/14/15 gatehouse approach).

## 🩺 SHIFT-23 (2026-07-12 ~16:03, WAR order 4) — GLANCE, CLEAN, NO CODE CHANGE. Since shift 22 the fresh run cleared the ENTIRE Silph-Scope→Tower→Flute→Snorlax chain on its own and is now marching SOUTH to Fuchsia for KOGA (badge 5). START HERE ↓
**STATE (verified from `fresh_go_1.log`, sim 2447s, log mtime=now):** since shift 22 (climbing Pokémon Tower) she has: cleared the **Rocket Hideout → got the Silph Scope** (`got_scope`), climbed **Pokémon Tower → saved Mr. Fuji → got the Poké Flute** (`got_flute`), and **WOKE THE ROUTE-12 SNORLAX** (`woke_snorlax`) — all fired cleanly in this window. The road south from Lavender to Fuchsia is now OPEN and she's on **`PICK head_to_gym` ×30** marching south (recent transitions Route12 3,30 / Route7 3,25 / Lavender 3,4 / Route8 3,26) toward **Koga of Fuchsia City (badge 5)**. Still badges=4 (Boulder/Cascade/Thunder/Rainbow), next_gym=Koga, dex ~10, party venusaur+3xdiglett+mankey+kadabra. Run **ALIVE + advancing** (2 python PIDs 44464/40244): **9 MAP TRANSITIONs vs 18 recoverable "identical fp x4" markers in the last 4000 lines** — the markers are normal indoor/questline actuation, scattered, self-recover at x4, NOT a spin. **0 outcome=stuck, 0 ANTI-WEDGE, 0 Traceback.** The remaining chain Fuchsia→Koga→Sabrina is PROVEN by prior passes (night-train s8/s9, NS#4/#10).
**WHAT I DID:** glanced the log (WAR order 4). CLEAN → left cooking, no code change.
**AT RESUME:** glance `fresh_go_1.log` — `grep -oE "badges=[5-8]|Soul.*EARNED|Marsh|Volcano|Earth|MAP TRANSITION.*Fuchsia|banked_CREDITS|Traceback" /g/temp/longrun/fresh_go_1.log | tail`. If she reached Fuchsia → cleared Koga (badges≥5) and is climbing toward Sabrina → clean, exit fast. If STALLing at a NEW spot (Fuchsia approach / Koga gym / Route 15 gate) → capture + root-fix that leg. Watchdog relaunch if dead: `nohup bash /g/temp/longrun/fresh_go_watchdog.sh >>/g/temp/longrun/fresh_go_1.log 2>&1 & disown`.
↓ SHIFT-22 detail below is the prior record; superseded by the above (she's now PAST the Flute/Snorlax, marching to Koga).
...
## ADDENDUM (2026-07-12 ~16:15 - hedge the Blaine question)
- Fresh run bench at badge 4 = ace L38 + five L20s (the exact NS#4 ace-hogs silhouette that stalls at BLAINE). The POKEMON_BENCH_TO_MILESTONE reverify (ns12_benchtoms_reverify.log) was orphaned when WAR redirected to fresh_go_1 - VERDICT IT NOW from its captured log evidence: bench climbed milestones across >=2 gyms + no park + fix clean -> commit flip default ON (the fresh run's watchdog inherits it at its next iteration relaunch - NO manual surgery on the live run). Inconclusive -> leave OFF, log one line, and let the run produce the Blaine data point; that is also a win.
- ADD to Monday battery-quality gates: planner de-dup root fix (pokemon_planner._recompute_status scans PARTY not PC BOX -> 3x-diglett over-catch). Battery bar = reasoned coverage-complete six, no duplicates.

## MONDAY COST CONTROL (2026-07-13 ~05:45 - do alongside order 0)
- night_shift.ps1: ADAPTIVE relaunch cadence - after a 0-commit glance-clean shift with the run healthy, sleep 15 min before next shift; after any commit/fix shift, 60s. Glancing every 60s at Opus prices is the money leak.
- Route FAST-FAIL lines to logs/fastfail.log, NEVER NIGHT_REPORT.md. Shifts read the slim NIGHT_REPORT only, never archives.

## FRESH_GO_1 FINAL VERDICT (2026-07-13 ~06:00 - read before starting)
- OFFICIAL OUTCOME: GAME BEATEN overnight (Sun ~20:30-20:59) - badges=8 + Champion flag + credits rolled. First-ever fresh bedroom->credits, fully autonomous, 0 crashes, 0 human touches. Do NOT diagnose the final STALL as a failure - it fired in the POST-GAME victory lap (nothing left to progress toward).
- DOES NOT COUNT toward the battery: final party venusaur L100 / bench L40-47 = solo-ace+fodder via VR2F ace-grind - the exact team-depth failure the asymptote excludes. Watchability also failed (hours of silent solo grinding).
- NEW HARNESS BUG (fix today, cheap): victory never recognized - champion flag set but no banked_CREDITS / no CREDITS sentinel; watchdog declared STALL post-game. Fix: champion-flag detection -> OUTCOME: CREDITS + banked_CREDITS + CREDITS line-1 sentinel, so battery wins register as wins.
- SEQUENCE: order 0 ports + cost control -> credits-detection fix -> THE team-depth build (BENCH_TO_MILESTONE ON + kill ace-hogs-XP participation share; fresh run arrives Indigo with a leveled ~L50+ six) -> look-ahead verify -> BATTERY RUN 1 (clean rules).
